...
function prepareFieldMap(){
  ...
  refreshChangeGraphics=()=>{
    ...
    const views=lang==="ar"?[["roads","الطرق والشوارع","الطرق السريعة والرئيسية والمحلية وأسماؤها","roads"],["cadastral","السجل العقاري والقطع","أرقام القطع والمباني والمنازل","cadastre"],["normal","الخريطة العامة","المدن والحدود الإدارية","overview"],["satellite","الصور الجوية","صور الأقمار الصناعية","imagery"]]:lang==="de"?[["roads","Straßen & Verkehrsnetz","Autobahnen, Haupt- und Nebenstraßen mit Namen","roads"],["cadastral","Kataster & Flurstücke","Flur-, Flurstücks-, Objekt- und Hausnummern","cadastre"],["normal","Übersichtskarte","Orte und Verwaltungsgrenzen","overview"],["satellite","Luftbild","Satellitenbild zur Orientierung","imagery"]]:[["roads","Roads & transport network","Motorways, primary and local roads with names","roads"],["cadastral","Cadastre & parcels","Section, parcel, object and house numbers","cadastre"],["normal","Overview map","Places and administrative boundaries","overview"],["satellite","Aerial imagery","Satellite imagery for orientation","imagery"]];
